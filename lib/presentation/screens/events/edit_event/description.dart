...
class _EditPostDescriptionState extends State<EditPostDescription> {
  ...
  void submitNewDescription() async {
    ...
    && (_descriptionController.text.trim().length != 0)) {
      ...
      if (res) {
        GetIt.I.get<EventManager>().setPostDescription(_descriptionController.text.trim());
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: TextField(
                  onChanged: (value) => setState(() => currentCharCount = _descriptionController.text.trim().length),
                  controller: _descriptionController,
                  maxLength: maxCharCount,
                  maxLines: 12,
                  decoration: InputDecoration(
                    hintText: 'Add a description for your event',
                    counter: Padding(padding: EdgeInsets.all(8.0),
                      child: Text('${currentCharCount.toString()} / ${maxCharCount.toString()}'),),
