...
import '../controllers/providers/event_provider.dart' as _i28;
import '../controllers/providers/legacy_location_provider.dart' as _i12;
...
import '../data/repositories/event_repository.dart' as _i10;
...
import '../services/firebase_otp.dart' as _i11;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i10.EventRepository>(() => _i10.EventRepository());
  gh.lazySingleton<_i11.FirebaseOtpService>(() => _i11.FirebaseOtpService());
  gh.singleton<_i12.GeolocationProvider>(_i12.GeolocationProvider());
  ...
  gh.lazySingleton<_i28.EventProvider>(() => _i28.EventProvider(
      eventRepository: get<_i10.EventRepository>(),
      tagRepository: get<_i26.TagRepository>()));
  return get;
}
